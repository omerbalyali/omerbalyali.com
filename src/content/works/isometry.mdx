...
<OriginalImage src={website} alt="Isometry website" class="card bleed" data-bleed="extra-wide" />
...
<OriginalImage src={aiNative} alt="AI-Native workflow diagram" class="card bleed" data-bleed="extra-wide" />
...
<OriginalImage src={cli} alt="CLI commands" class="card bleed" data-bleed="extra-wide" />
